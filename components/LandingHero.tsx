...
export const Landinghero = () => {
  ...
  return (
    <div className={"text-white font-bold py-36 text-center space-y-5"}>
      <div
        className={
          "text-4xl sm:text-5xl md:text-6xl lg:text-7xl space-y-5 font-extrabold"
        }
      >
        ...
        <div
          className={
            "text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-emerald-600"
          }
        >
          <h2 className={"text-6xl font-bold"}>
            votre plus belle experience musicale
          </h2>
        </div>
      </div>
